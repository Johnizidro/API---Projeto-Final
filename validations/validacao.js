...
const serVerValidator = Joi.object({
  codigoSisbov: Joi.string()
    .alphanum()
    .length(15)
    .required()
    .messages({
      "string.base": "Código Sisbov deve ser um texto alfanumérico",
      "string.empty": "Código Sisbov é obrigatório",
      "string.length": "Código Sisbov deve ter exatamente 15 caracteres",
      "string.alphanum": "Código Sisbov deve conter apenas letras e números",
  ...
  // Se quiser validar userId, segue exemplo (opcional)
  /*
  userId: Joi.string()
    .length(24)
    .hex()
    ...
    .messages({
      ...
      "string.length": "UserId deve ter 24 caracteres hexadecimais",
